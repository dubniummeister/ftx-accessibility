...
@onready var option1_text = $ColorRect2/Option1RichTextLabel
@onready var option2_text = $ColorRect2/Option2RichTextLabel
@onready var option3_text = $ColorRect2/Option3RichTextLabel
